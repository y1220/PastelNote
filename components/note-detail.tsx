...
export function NoteDetail({ note, onClose }: { note: any, onClose: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 font-quicksand">
      <div className="max-w-4xl mx-auto p-6">
        <Button variant="ghost" size="sm" className="mb-4" onClick={onClose}>
          ← Back to Notes
        </Button>
        {/* Header */}
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-white/60 p-8 mb-6">
          ...
          <div className="flex items-center gap-4 text-sm text-gray-500 mb-6 font-medium">
            <div className="flex items-center gap-2">
              ...
              <span>Updated Jun 8, 2025</span>
            </div>
            <Separator orientation="vertical" className="h-4" />
            <Badge variant="secondary" className="bg-blue-50 text-blue-700 hover:bg-blue-100 font-medium">
              Personal
            </Badge>
            <Badge variant="secondary" className="bg-green-50 text-green-700 hover:bg-green-100 font-medium">
              Draft
            </Badge>
          </div>
        ...
        <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 text-center border border-white/40">
            <div className="text-2xl font-bold text-gray-900 font-quicksand">247</div>
            <div className="text-sm text-gray-500 font-medium">Words</div>
          </div>
          <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 text-center border border-white/40">
            <div className="text-2xl font-bold text-gray-900 font-quicksand">3</div>
            <div className="text-sm text-gray-500 font-medium">Links</div>
          </div>
          <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 text-center border border-white/40">
            <div className="text-2xl font-bold text-gray-900 font-quicksand">12</div>
            <div className="text-sm text-gray-500 font-medium">Views</div>
          </div>
          <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 text-center border border-white/40">
            <div className="text-2xl font-bold text-gray-900 font-quicksand">2m</div>
            <div className="text-sm text-gray-500 font-medium">Read time</div>
          </div>
        </div>
      </div>
    </div>
